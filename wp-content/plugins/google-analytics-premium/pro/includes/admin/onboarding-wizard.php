...
class MonsterInsights_Onboarding_Wizard_Pro {
	...
	public function onboarding_wizard_header() {
		...
		<head>
			...
			<title><?php esc_html_e( 'MonsterInsights &rsaquo; Onboarding Wizard', 'google-analytics-premium' ); ?></title>
	...
	public function onboarding_wizard_content() {
		...
		monsterinsights_settings_error_page( 'monsterinsights-vue-onboarding-wizard', '<a href="' . $admin_url . '">' . esc_html__( 'Return to Dashboard', 'google-analytics-premium' ) . '</a>' );
	...
	public function install_and_activate_wpforms() {
		...
		if ( ! monsterinsights_can_install_plugins() ) {
			wp_send_json( array(
				'message' => esc_html__( 'You are not allowed to install plugins', 'google-analytics-premium' ),
			) );
		}
