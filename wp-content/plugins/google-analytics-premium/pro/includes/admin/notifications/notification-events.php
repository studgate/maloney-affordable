...
require_once plugin_dir_path( $base->file ) . '/pro/includes/admin/notifications/notification-check-compliance.php';
require_once plugin_dir_path( $base->file ) . '/pro/includes/admin/notifications/notification-ai-insight.php';
