...
class MonsterInsights_PPC_Tracking_Core {
	...
	private function require_files() {
		...
		//  Load forms class
		require_once MONSTERINSIGHTS_PLUGIN_DIR . 'pro/includes/ppc/class-monsterinsights-ads-forms.php';
		
		//  Load parent classes
		if ( !class_exists('MonsterInsights_Ads_Tracking_Provider') ) {
			require_once MONSTERINSIGHTS_PLUGIN_DIR . 'pro/includes/ppc/class-monsterinsights-ads-tracking-provider.php';
		}
		
		if ( !class_exists('MonsterInsights_Ads_Tracking_Ecommerce_Tracking') ) {
			require_once MONSTERINSIGHTS_PLUGIN_DIR . 'pro/includes/ppc/ecommerce-providers/class-monsterinsights-ads-tracking-ecommerce-tracking.php';
		}
		
		//  Load Google PAX Tracking class
		require_once MONSTERINSIGHTS_PLUGIN_DIR . 'pro/includes/ppc/google/class-monsterinsights-google-ads-pax.php';
		...
		if ( !class_exists('MonsterInsights_Ads_Tracking_Ecommerce_Woo') ) {
			require_once MONSTERINSIGHTS_PLUGIN_DIR . 'pro/includes/ppc/ecommerce-providers/class-monsterinsights-ads-tracking-ecommerce-woo.php';
		}

		//  EDD
		if ( !class_exists('MonsterInsights_Ads_Tracking_Ecommerce_EDD') ) {
			require_once MONSTERINSIGHTS_PLUGIN_DIR . 'pro/includes/ppc/ecommerce-providers/class-monsterinsights-ads-tracking-ecommerce-edd.php';
		}

		//  MemberPress
		if ( !class_exists('MonsterInsights_Ads_Tracking_Ecommerce_MemberPress') ) {
			require_once MONSTERINSIGHTS_PLUGIN_DIR . 'pro/includes/ppc/ecommerce-providers/class-monsterinsights-ads-tracking-ecommerce-memberpress.php';
		}

		//  RCP
		if ( !class_exists('MonsterInsights_Ads_Tracking_Ecommerce_RCP') ) {
			require_once MONSTERINSIGHTS_PLUGIN_DIR . 'pro/includes/ppc/ecommerce-providers/class-monsterinsights-ads-tracking-ecommerce-rcp.php';
		}

		//  GiveWP
		if ( !class_exists('MonsterInsights_Ads_Tracking_Ecommerce_GiveWP') ) {
			require_once MONSTERINSIGHTS_PLUGIN_DIR . 'pro/includes/ppc/ecommerce-providers/class-monsterinsights-ads-tracking-ecommerce-give-wp.php';
		}

		//  LifterLMS
		if ( !class_exists('MonsterInsights_Ads_Tracking_Ecommerce_Lifter_LMS') ) {
			require_once MONSTERINSIGHTS_PLUGIN_DIR . 'pro/includes/ppc/ecommerce-providers/class-monsterinsights-ads-tracking-ecommerce-lifter-lms.php';
		}
	}
}
