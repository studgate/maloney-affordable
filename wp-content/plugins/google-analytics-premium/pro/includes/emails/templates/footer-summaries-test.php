					...
					<table align="left" border="0" cellpadding="0" cellspacing="0" width="100%"
						...
						<tr>
							<td valign="top" class="mcnTextContent"
								...
								$footer = sprintf( esc_html__( 'To make sure you keep getting these emails, please add %1$s to your address book or whitelist us. Want out of the loop? %2$s', 'google-analytics-premium' ), '<a href="mailto:' . $from_address . '" style="color:#4B9BF0;text-decoration:none;">' . $from_address . '</a>', '<a href="' . $settings_tab_url . '" target="_blank" style="color:#4B9BF0;text-decoration:none;">Unsubscribe.</a>' );
