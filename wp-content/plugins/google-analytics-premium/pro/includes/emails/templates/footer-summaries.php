						...
						<tr>
							<td valign="top" class="mcnTextContent"
								...
								$footer = sprintf(
									...
									esc_html__(
										'To make sure you keep getting these emails, please add %1$s to your address book or whitelist us. Want out of the loop? %2$sUnsubscribe%3$s.', 'google-analytics-premium' ),
