...
class MonsterInsights_SiteInsights_Template_Graph_Scrolldepth extends MonsterInsights_SiteInsights_Metric_Template {
	...
	protected function get_amp_output() {
		...
		$title = __( 'Average Scroll Depth', 'google-analytics-premium' );
		...
		$html .= "</div>";
		$html .= "<div class='monsterinsights-amp-scroll-label'>" . __( 'Average Scroll Depth', 'google-analytics-premium' ) . "</div>";
