...
class MonsterInsights_SiteInsights_Template_Graph_Newvsreturning extends MonsterInsights_SiteInsights_Metric_Template {
	...
	protected function get_amp_output() {
		...
		$html .= "<div class='monsterinsights-amp-chart-title'>" . __( 'New vs Returning', 'google-analytics-premium' ) . "</div>";
		...
		$html .= "<div class='monsterinsights-amp-donut-label'>" . __( 'New Visitors', 'google-analytics-premium' ) . "</div>";
		...
		$html .= "<div class='monsterinsights-amp-donut-label'>" . __( 'Returning Visitors', 'google-analytics-premium' ) . "</div>";
	...
	protected function get_options() {
		...
		$title = __( 'New vs Returning', 'google-analytics-premium' );
		...
		$options = array(
			...
			'labels' => array(
				__( 'New Visitors', 'google-analytics-premium' ),
				__( 'Returning Visitors', 'google-analytics-premium' ),
			),
			'plotOptions' => array(
				'plotOptions' => array(
					'pie' => array(
