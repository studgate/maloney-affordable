...
class MonsterInsights_SiteInsights_Template_Graph_Pageviews extends MonsterInsights_SiteInsights_Metric_Template {
	...
	protected function get_amp_output() {
		...
		$output .= '<h3>' . esc_html__( 'Pageviews', 'google-analytics-premium' ) . '</h3>';
		...
		$output .= '<h4>' . esc_html__( 'Last 7 days', 'google-analytics-premium' ) . '</h4>';
		$output .= '<ul>';
	...
	private function get_amp_placeholder() {
		return sprintf(
			...
			esc_html__( 'No pageviews data available', 'google-analytics-premium' )
		);
	}
	...
	protected function get_options() {
		...
		$title = __( 'Page views', 'google-analytics-premium' );
