...
class MonsterInsights_WP_Emails {
	...
	public function set_initial_args() {
		$header_args = array(
			'title' => esc_html__( 'MonsterInsights', 'google-analytics-premium' ),
		);
	...
	public function send( $to, $subject, $message = null, $attachments = array() ) {
		...
		if ( ! did_action( 'init' ) && ! did_action( 'admin_init' ) ) {
			_doing_it_wrong( __FUNCTION__, esc_html__( 'You cannot send emails with MI_WP_Emails() until init/admin_init has been reached.', 'google-analytics-premium' ), null );
