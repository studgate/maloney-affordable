...
class MonsterInsights_WP_Site_Health {
	...
	public function add_tests( $tests ) {
		$tests['direct']['monsterinsights_dual_tracking'] = array(
			'label' => __( 'MonsterInsights Dual Tracking', 'google-analytics-premium' ),
	...
	public function test_dual_tracking() {
		...
		return array(
			'label'       => __( 'Enable Google Analytics 4', 'google-analytics-premium' ),
			'status'      => 'critical',
			'badge'       => array(
				'label' => __( 'MonsterInsights', 'google-analytics-premium' ),
				'color' => 'blue',
			),
			'description' => __( 'Starting July 1, 2023, Google\'s Universal Analytics (GA3) will not accept any new traffic or event data. Upgrade to Google Analytics 4 today to be prepared for the sunset.', 'google-analytics-premium' ),
			'actions'     => sprintf(
				'<p><a href="%s" target="_blank" rel="noopener noreferrer">%s</a></p>',
				$setup_link,
				__( 'Set Up Dual Tracking', 'google-analytics-premium' )
			),
