...
final class MonsterInsights_Notification_Upgrade_For_Custom_Dimensions extends MonsterInsights_Notification_Event {
	...
	public function prepare_notification_data( $notification ) {
		$notification['title'] = __( 'Upgrade to MonsterInsights Pro', 'google-analytics-premium' );
		// Translators: upgrade for form conversion notification content
		$notification['content'] = __( 'Upgrade to enable Custom Dimensions. Track logged in users, determine when is your best time to post, measure if your SEO strategy is working, and find your most popular author.', 'google-analytics-premium' );
		$notification['btns']    = array(
			"get_monsterinsights_pro" => array(
				'url'         => $this->get_upgrade_url(),
				'text'        => __( 'Get MonsterInsights Pro', 'google-analytics-premium' ),
				'is_external' => true,
			),
		);
