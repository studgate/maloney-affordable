...
class MonsterInsights_Notification_Multiple_Gtags extends MonsterInsights_Notification_Event {
	...
	public function prepare_notification_data( $notification ) {
		...
		if ( is_array( $response ) ) {
			...
			$notification['title']   = __( "Multiple Google Analytics Tags Found", "google-analytics-premium" );
			$notification['content'] = __( "MonsterInsights has detected multiple analytics tags on your website. Please disable the other plugin to ensure accurate tracking.", 'google-analytics-premium' );
