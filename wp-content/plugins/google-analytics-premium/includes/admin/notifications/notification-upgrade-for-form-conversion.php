...
final class MonsterInsights_Notification_Upgrade_For_Form_Conversion extends MonsterInsights_Notification_Event {
	...
	public function prepare_notification_data( $notification ) {
		$notification['title'] = __( 'Easily Track Form Conversions', 'google-analytics-premium' );
		/* translators: Placeholders add a link to the settings page. */
		$notification['content'] = sprintf( __( 'Track your website\'s form conversion rates by upgrading to %1$sMonsterInsights Pro%2$s.', 'google-analytics-premium' ), '<a href="' . $this->get_upgrade_url() . '" target="_blank">', '</a>' );
