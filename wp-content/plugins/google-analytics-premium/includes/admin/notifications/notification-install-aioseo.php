...
final class MonsterInsights_Notification_Install_AIOSEO extends MonsterInsights_Notification_Event {
	...
	public function prepare_notification_data( $notification ) {
		...
		if ( ! $seo_plugin_active ) {
			$notification['title']   = __( 'Install All-In-One SEO', 'google-analytics-premium' );
			$notification['content'] = __( 'Install All in One SEO to optimize your site for better search engine rankings.', 'google-analytics-premium' );
