...
final class MonsterInsights_Notification_Upgrade_For_Post_Templates extends MonsterInsights_Notification_Event {
	...
	public function prepare_notification_data( $notification ) {
		...
		$notification['content'] = __( 'Upgrade MonsterInsights Pro and use up to 20+ Popular Post templates to help improve engagement and interaction on your site.', 'google-analytics-premium' );
