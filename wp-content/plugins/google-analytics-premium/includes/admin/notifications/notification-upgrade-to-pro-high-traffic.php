...
final class MonsterInsights_Notification_Upgrade_To_Pro_High_Traffic extends MonsterInsights_Notification_Event {
	...
	public function prepare_notification_data( $notification ) {
		...
		$notification['content'] = __( 'Upgrade to MonsterInsights Pro to take advantage of advanced Google Analytics settings, unlock advanced insights, utilize Custom Dimensions, and more.', 'google-analytics-premium' );
