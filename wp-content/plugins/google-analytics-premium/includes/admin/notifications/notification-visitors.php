...
final class MonsterInsights_Notification_Visitors extends MonsterInsights_Notification_Event {
	...
	public function prepare_notification_data( $notification ) {
		...
		$notification['title'] = sprintf( __( 'See how %s Visitors Found Your Site!', 'google-analytics-premium' ), $total_visitors );
		// Translators: visitors notification content
		$notification['content'] = sprintf( __( 'Your website has been visited by %s visitors in the past 30 days. Click the button below to view the full analytics report.', 'google-analytics-premium' ), $total_visitors );
