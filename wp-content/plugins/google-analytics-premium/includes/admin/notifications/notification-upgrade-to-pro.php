...
final class MonsterInsights_Notification_Upgrade_To_Pro extends MonsterInsights_Notification_Event {
	...
	public function prepare_notification_data( $notification ) {
		$notification['title'] = __( 'Upgrade to Unlock Advanced Tracking & Reports', 'google-analytics-premium' );
		// Translators: upgrade to pro notification content
		$notification['content'] = __( 'By upgrading to MonsterInsights Pro you get access to additional reports right in your WordPress dashboard and advanced tracking features like eCommerce, Custom Dimensions, Forms tracking and more!', 'google-analytics-premium' );
