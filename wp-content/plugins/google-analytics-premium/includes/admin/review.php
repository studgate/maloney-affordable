		...
		<div class="notice notice-info is-dismissible monsterinsights-review-notice">
			<div class="monsterinsights-review-step">
				<p>
					...
					echo wp_kses(
						sprintf(
							__( 'Hey - we noticed you\'ve been using %1$s for a while - that\'s great! Could you do us a BIG favor and give it a 5-star review on WordPress to help us spread the word and boost our motivation?', 'google-analytics-premium' ),
				...
				<p>
					<a
						href="https://wordpress.org/support/plugin/google-analytics-premium/reviews/?filter=5#new-post"
						   class="monsterinsights-dismiss-review-notice monsterinsights-review-out"
						target="_blank"
						   rel="noopener noreferrer"
					>
						<?php esc_html_e( 'Ok, you deserve it', 'google-analytics-premium' ); ?>
					</a>
					<br>
					<a
						href="#"
						class="monsterinsights-dismiss-review-notice monsterinsights-review-later"
						   rel="noopener noreferrer"
					>
						<?php esc_html_e( 'Nope, maybe later', 'google-analytics-premium' ); ?>
					</a>
					<br>
					<a
						href="#"
						class="monsterinsights-dismiss-review-notice"
						   rel="noopener noreferrer"
					>
						<?php esc_html_e( 'I already did', 'google-analytics-premium' ); ?>
					</a>
				</p>
			</div>
		</div>
