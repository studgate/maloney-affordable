...
function monsterinsights_get_country_list( $translated = false ) {
	if ( $translated ) {
		$countries = array(
			''   => '',
			'US' => __( 'United States', 'google-analytics-premium' ),
			'CA' => __( 'Canada', 'google-analytics-premium' ),
			'GB' => __( 'United Kingdom', 'google-analytics-premium' ),
			'AF' => __( 'Afghanistan', 'google-analytics-premium' ),
			'AX' => __( '&#197;land Islands', 'google-analytics-premium' ),
			'AL' => __( 'Albania', 'google-analytics-premium' ),
			'DZ' => __( 'Algeria', 'google-analytics-premium' ),
			'AS' => __( 'American Samoa', 'google-analytics-premium' ),
			'AD' => __( 'Andorra', 'google-analytics-premium' ),
			'AO' => __( 'Angola', 'google-analytics-premium' ),
			'AI' => __( 'Anguilla', 'google-analytics-premium' ),
			'AQ' => __( 'Antarctica', 'google-analytics-premium' ),
			'AG' => __( 'Antigua and Barbuda', 'google-analytics-premium' ),
			'AR' => __( 'Argentina', 'google-analytics-premium' ),
			'AM' => __( 'Armenia', 'google-analytics-premium' ),
			'AW' => __( 'Aruba', 'google-analytics-premium' ),
			'AU' => __( 'Australia', 'google-analytics-premium' ),
			'AT' => __( 'Austria', 'google-analytics-premium' ),
			'AZ' => __( 'Azerbaijan', 'google-analytics-premium' ),
			'BS' => __( 'Bahamas', 'google-analytics-premium' ),
			'BH' => __( 'Bahrain', 'google-analytics-premium' ),
			'BD' => __( 'Bangladesh', 'google-analytics-premium' ),
			'BB' => __( 'Barbados', 'google-analytics-premium' ),
			'BY' => __( 'Belarus', 'google-analytics-premium' ),
			'BE' => __( 'Belgium', 'google-analytics-premium' ),
			'BZ' => __( 'Belize', 'google-analytics-premium' ),
			'BJ' => __( 'Benin', 'google-analytics-premium' ),
			'BM' => __( 'Bermuda', 'google-analytics-premium' ),
			'BT' => __( 'Bhutan', 'google-analytics-premium' ),
			'BO' => __( 'Bolivia', 'google-analytics-premium' ),
			'BQ' => __( 'Bonaire, Saint Eustatius and Saba', 'google-analytics-premium' ),
			'BA' => __( 'Bosnia and Herzegovina', 'google-analytics-premium' ),
			'BW' => __( 'Botswana', 'google-analytics-premium' ),
			'BV' => __( 'Bouvet Island', 'google-analytics-premium' ),
			'BR' => __( 'Brazil', 'google-analytics-premium' ),
			'IO' => __( 'British Indian Ocean Territory', 'google-analytics-premium' ),
			'BN' => __( 'Brunei Darrussalam', 'google-analytics-premium' ),
			'BG' => __( 'Bulgaria', 'google-analytics-premium' ),
			'BF' => __( 'Burkina Faso', 'google-analytics-premium' ),
			'BI' => __( 'Burundi', 'google-analytics-premium' ),
			'KH' => __( 'Cambodia', 'google-analytics-premium' ),
			'CM' => __( 'Cameroon', 'google-analytics-premium' ),
			'CV' => __( 'Cape Verde', 'google-analytics-premium' ),
			'KY' => __( 'Cayman Islands', 'google-analytics-premium' ),
			'CF' => __( 'Central African Republic', 'google-analytics-premium' ),
			'TD' => __( 'Chad', 'google-analytics-premium' ),
			'CL' => __( 'Chile', 'google-analytics-premium' ),
			'CN' => __( 'China', 'google-analytics-premium' ),
			'CX' => __( 'Christmas Island', 'google-analytics-premium' ),
			'CC' => __( 'Cocos Islands', 'google-analytics-premium' ),
			'CO' => __( 'Colombia', 'google-analytics-premium' ),
			'KM' => __( 'Comoros', 'google-analytics-premium' ),
			'CD' => __( 'Congo, Democratic People\'s Republic', 'google-analytics-premium' ),
			'CG' => __( 'Congo, Republic of', 'google-analytics-premium' ),
			'CK' => __( 'Cook Islands', 'google-analytics-premium' ),
			'CR' => __( 'Costa Rica', 'google-analytics-premium' ),
			'CI' => __( 'Cote d\'Ivoire', 'google-analytics-premium' ),
			'HR' => __( 'Croatia/Hrvatska', 'google-analytics-premium' ),
			'CU' => __( 'Cuba', 'google-analytics-premium' ),
			'CW' => __( 'Cura&Ccedil;ao', 'google-analytics-premium' ),
			'CY' => __( 'Cyprus', 'google-analytics-premium' ),
			'CZ' => __( 'Czechia', 'google-analytics-premium' ),
			'DK' => __( 'Denmark', 'google-analytics-premium' ),
			'DJ' => __( 'Djibouti', 'google-analytics-premium' ),
			'DM' => __( 'Dominica', 'google-analytics-premium' ),
			'DO' => __( 'Dominican Republic', 'google-analytics-premium' ),
			'TP' => __( 'East Timor', 'google-analytics-premium' ),
			'EC' => __( 'Ecuador', 'google-analytics-premium' ),
			'EG' => __( 'Egypt', 'google-analytics-premium' ),
			'GQ' => __( 'Equatorial Guinea', 'google-analytics-premium' ),
			'SV' => __( 'El Salvador', 'google-analytics-premium' ),
			'ER' => __( 'Eritrea', 'google-analytics-premium' ),
			'EE' => __( 'Estonia', 'google-analytics-premium' ),
			'ET' => __( 'Ethiopia', 'google-analytics-premium' ),
			'FK' => __( 'Falkland Islands', 'google-analytics-premium' ),
			'FO' => __( 'Faroe Islands', 'google-analytics-premium' ),
			'FJ' => __( 'Fiji', 'google-analytics-premium' ),
			'FI' => __( 'Finland', 'google-analytics-premium' ),
			'FR' => __( 'France', 'google-analytics-premium' ),
			'GF' => __( 'French Guiana', 'google-analytics-premium' ),
			'PF' => __( 'French Polynesia', 'google-analytics-premium' ),
			'TF' => __( 'French Southern Territories', 'google-analytics-premium' ),
			'GA' => __( 'Gabon', 'google-analytics-premium' ),
			'GM' => __( 'Gambia', 'google-analytics-premium' ),
			'GE' => __( 'Georgia', 'google-analytics-premium' ),
			'DE' => __( 'Germany', 'google-analytics-premium' ),
			'GR' => __( 'Greece', 'google-analytics-premium' ),
			'GH' => __( 'Ghana', 'google-analytics-premium' ),
			'GI' => __( 'Gibraltar', 'google-analytics-premium' ),
			'GL' => __( 'Greenland', 'google-analytics-premium' ),
			'GD' => __( 'Grenada', 'google-analytics-premium' ),
			'GP' => __( 'Guadeloupe', 'google-analytics-premium' ),
			'GU' => __( 'Guam', 'google-analytics-premium' ),
			'GT' => __( 'Guatemala', 'google-analytics-premium' ),
			'GG' => __( 'Guernsey', 'google-analytics-premium' ),
			'GN' => __( 'Guinea', 'google-analytics-premium' ),
			'GW' => __( 'Guinea-Bissau', 'google-analytics-premium' ),
			'GY' => __( 'Guyana', 'google-analytics-premium' ),
			'HT' => __( 'Haiti', 'google-analytics-premium' ),
			'HM' => __( 'Heard and McDonald Islands', 'google-analytics-premium' ),
			'VA' => __( 'Holy See (City Vatican State)', 'google-analytics-premium' ),
			'HN' => __( 'Honduras', 'google-analytics-premium' ),
			'HK' => __( 'Hong Kong', 'google-analytics-premium' ),
			'HU' => __( 'Hungary', 'google-analytics-premium' ),
			'IS' => __( 'Iceland', 'google-analytics-premium' ),
			'IN' => __( 'India', 'google-analytics-premium' ),
			'ID' => __( 'Indonesia', 'google-analytics-premium' ),
			'IR' => __( 'Iran', 'google-analytics-premium' ),
			'IQ' => __( 'Iraq', 'google-analytics-premium' ),
			'IE' => __( 'Ireland', 'google-analytics-premium' ),
			'IM' => __( 'Isle of Man', 'google-analytics-premium' ),
			'IL' => __( 'Israel', 'google-analytics-premium' ),
			'IT' => __( 'Italy', 'google-analytics-premium' ),
			'JM' => __( 'Jamaica', 'google-analytics-premium' ),
			'JP' => __( 'Japan', 'google-analytics-premium' ),
			'JE' => __( 'Jersey', 'google-analytics-premium' ),
			'JO' => __( 'Jordan', 'google-analytics-premium' ),
			'KZ' => __( 'Kazakhstan', 'google-analytics-premium' ),
			'KE' => __( 'Kenya', 'google-analytics-premium' ),
			'KI' => __( 'Kiribati', 'google-analytics-premium' ),
			'KW' => __( 'Kuwait', 'google-analytics-premium' ),
			'KG' => __( 'Kyrgyzstan', 'google-analytics-premium' ),
			'LA' => __( 'Lao People\'s Democratic Republic', 'google-analytics-premium' ),
			'LV' => __( 'Latvia', 'google-analytics-premium' ),
			'LB' => __( 'Lebanon', 'google-analytics-premium' ),
			'LS' => __( 'Lesotho', 'google-analytics-premium' ),
			'LR' => __( 'Liberia', 'google-analytics-premium' ),
			'LY' => __( 'Libyan Arab Jamahiriya', 'google-analytics-premium' ),
			'LI' => __( 'Liechtenstein', 'google-analytics-premium' ),
			'LT' => __( 'Lithuania', 'google-analytics-premium' ),
			'LU' => __( 'Luxembourg', 'google-analytics-premium' ),
			'MO' => __( 'Macau', 'google-analytics-premium' ),
			'MK' => __( 'Macedonia (FYROM)', 'google-analytics-premium' ),
			'MG' => __( 'Madagascar', 'google-analytics-premium' ),
			'MW' => __( 'Malawi', 'google-analytics-premium' ),
			'MY' => __( 'Malaysia', 'google-analytics-premium' ),
			'MV' => __( 'Maldives', 'google-analytics-premium' ),
			'ML' => __( 'Mali', 'google-analytics-premium' ),
			'MT' => __( 'Malta', 'google-analytics-premium' ),
			'MH' => __( 'Marshall Islands', 'google-analytics-premium' ),
			'MQ' => __( 'Martinique', 'google-analytics-premium' ),
			'MR' => __( 'Mauritania', 'google-analytics-premium' ),
			'MU' => __( 'Mauritius', 'google-analytics-premium' ),
			'YT' => __( 'Mayotte', 'google-analytics-premium' ),
			'MX' => __( 'Mexico', 'google-analytics-premium' ),
			'FM' => __( 'Micronesia', 'google-analytics-premium' ),
			'MD' => __( 'Moldova, Republic of', 'google-analytics-premium' ),
			'MC' => __( 'Monaco', 'google-analytics-premium' ),
			'MN' => __( 'Mongolia', 'google-analytics-premium' ),
			'ME' => __( 'Montenegro', 'google-analytics-premium' ),
			'MS' => __( 'Montserrat', 'google-analytics-premium' ),
			'MA' => __( 'Morocco', 'google-analytics-premium' ),
			'MZ' => __( 'Mozambique', 'google-analytics-premium' ),
			'MM' => __( 'Myanmar', 'google-analytics-premium' ),
			'NA' => __( 'Namibia', 'google-analytics-premium' ),
			'NR' => __( 'Nauru', 'google-analytics-premium' ),
			'NP' => __( 'Nepal', 'google-analytics-premium' ),
			'NL' => __( 'Netherlands', 'google-analytics-premium' ),
			'AN' => __( 'Netherlands Antilles', 'google-analytics-premium' ),
			'NC' => __( 'New Caledonia', 'google-analytics-premium' ),
			'NZ' => __( 'New Zealand', 'google-analytics-premium' ),
			'NI' => __( 'Nicaragua', 'google-analytics-premium' ),
			'NE' => __( 'Niger', 'google-analytics-premium' ),
			'NG' => __( 'Nigeria', 'google-analytics-premium' ),
			'NU' => __( 'Niue', 'google-analytics-premium' ),
			'NF' => __( 'Norfolk Island', 'google-analytics-premium' ),
			'KP' => __( 'North Korea', 'google-analytics-premium' ),
			'MP' => __( 'Northern Mariana Islands', 'google-analytics-premium' ),
			'NO' => __( 'Norway', 'google-analytics-premium' ),
			'OM' => __( 'Oman', 'google-analytics-premium' ),
			'PK' => __( 'Pakistan', 'google-analytics-premium' ),
			'PW' => __( 'Palau', 'google-analytics-premium' ),
			'PS' => __( 'Palestinian Territories', 'google-analytics-premium' ),
			'PA' => __( 'Panama', 'google-analytics-premium' ),
			'PG' => __( 'Papua New Guinea', 'google-analytics-premium' ),
			'PY' => __( 'Paraguay', 'google-analytics-premium' ),
			'PE' => __( 'Peru', 'google-analytics-premium' ),
			'PH' => __( 'Philippines', 'google-analytics-premium' ),
			'PN' => __( 'Pitcairn Island', 'google-analytics-premium' ),
			'PL' => __( 'Poland', 'google-analytics-premium' ),
			'PT' => __( 'Portugal', 'google-analytics-premium' ),
			'PR' => __( 'Puerto Rico', 'google-analytics-premium' ),
			'QA' => __( 'Qatar', 'google-analytics-premium' ),
			'XK' => __( 'Republic of Kosovo', 'google-analytics-premium' ),
			'RE' => __( 'Reunion Island', 'google-analytics-premium' ),
			'RO' => __( 'Romania', 'google-analytics-premium' ),
			'RU' => __( 'Russian Federation', 'google-analytics-premium' ),
			'RW' => __( 'Rwanda', 'google-analytics-premium' ),
			'BL' => __( 'Saint Barth&eacute;lemy', 'google-analytics-premium' ),
			'SH' => __( 'Saint Helena', 'google-analytics-premium' ),
			'KN' => __( 'Saint Kitts and Nevis', 'google-analytics-premium' ),
			'LC' => __( 'Saint Lucia', 'google-analytics-premium' ),
			'MF' => __( 'Saint Martin (French)', 'google-analytics-premium' ),
			'SX' => __( 'Saint Martin (Dutch)', 'google-analytics-premium' ),
			'PM' => __( 'Saint Pierre and Miquelon', 'google-analytics-premium' ),
			'VC' => __( 'Saint Vincent and the Grenadines', 'google-analytics-premium' ),
			'SM' => __( 'San Marino', 'google-analytics-premium' ),
			'ST' => __( 'S&atilde;o Tom&eacute; and Pr&iacute;ncipe', 'google-analytics-premium' ),
			'SA' => __( 'Saudi Arabia', 'google-analytics-premium' ),
			'SN' => __( 'Senegal', 'google-analytics-premium' ),
			'RS' => __( 'Serbia', 'google-analytics-premium' ),
			'SC' => __( 'Seychelles', 'google-analytics-premium' ),
			'SL' => __( 'Sierra Leone', 'google-analytics-premium' ),
			'SG' => __( 'Singapore', 'google-analytics-premium' ),
			'SK' => __( 'Slovak Republic', 'google-analytics-premium' ),
			'SI' => __( 'Slovenia', 'google-analytics-premium' ),
			'SB' => __( 'Solomon Islands', 'google-analytics-premium' ),
			'SO' => __( 'Somalia', 'google-analytics-premium' ),
			'ZA' => __( 'South Africa', 'google-analytics-premium' ),
			'GS' => __( 'South Georgia', 'google-analytics-premium' ),
			'KR' => __( 'South Korea', 'google-analytics-premium' ),
			'SS' => __( 'South Sudan', 'google-analytics-premium' ),
			'ES' => __( 'Spain', 'google-analytics-premium' ),
			'LK' => __( 'Sri Lanka', 'google-analytics-premium' ),
			'SD' => __( 'Sudan', 'google-analytics-premium' ),
			'SR' => __( 'Suriname', 'google-analytics-premium' ),
			'SJ' => __( 'Svalbard and Jan Mayen Islands', 'google-analytics-premium' ),
			'SZ' => __( 'Swaziland', 'google-analytics-premium' ),
			'SE' => __( 'Sweden', 'google-analytics-premium' ),
			'CH' => __( 'Switzerland', 'google-analytics-premium' ),
			'SY' => __( 'Syrian Arab Republic', 'google-analytics-premium' ),
			'TW' => __( 'Taiwan', 'google-analytics-premium' ),
			'TJ' => __( 'Tajikistan', 'google-analytics-premium' ),
			'TZ' => __( 'Tanzania', 'google-analytics-premium' ),
			'TH' => __( 'Thailand', 'google-analytics-premium' ),
			'TL' => __( 'Timor-Leste', 'google-analytics-premium' ),
			'TG' => __( 'Togo', 'google-analytics-premium' ),
			'TK' => __( 'Tokelau', 'google-analytics-premium' ),
			'TO' => __( 'Tonga', 'google-analytics-premium' ),
			'TT' => __( 'Trinidad and Tobago', 'google-analytics-premium' ),
			'TN' => __( 'Tunisia', 'google-analytics-premium' ),
			'TR' => __( 'Turkey', 'google-analytics-premium' ),
			'TM' => __( 'Turkmenistan', 'google-analytics-premium' ),
			'TC' => __( 'Turks and Caicos Islands', 'google-analytics-premium' ),
			'TV' => __( 'Tuvalu', 'google-analytics-premium' ),
			'UG' => __( 'Uganda', 'google-analytics-premium' ),
			'UA' => __( 'Ukraine', 'google-analytics-premium' ),
			'AE' => __( 'United Arab Emirates', 'google-analytics-premium' ),
			'UY' => __( 'Uruguay', 'google-analytics-premium' ),
			'UM' => __( 'US Minor Outlying Islands', 'google-analytics-premium' ),
			'UZ' => __( 'Uzbekistan', 'google-analytics-premium' ),
			'VU' => __( 'Vanuatu', 'google-analytics-premium' ),
			'VE' => __( 'Venezuela', 'google-analytics-premium' ),
			'VN' => __( 'Vietnam', 'google-analytics-premium' ),
			'VG' => __( 'Virgin Islands (British)', 'google-analytics-premium' ),
			'VI' => __( 'Virgin Islands (USA)', 'google-analytics-premium' ),
			'WF' => __( 'Wallis and Futuna Islands', 'google-analytics-premium' ),
			'EH' => __( 'Western Sahara', 'google-analytics-premium' ),
			'WS' => __( 'Western Samoa', 'google-analytics-premium' ),
			'YE' => __( 'Yemen', 'google-analytics-premium' ),
			'ZM' => __( 'Zambia', 'google-analytics-premium' ),
			'ZW' => __( 'Zimbabwe', 'google-analytics-premium' ),
			'ZZ' => __( 'Unknown Country', 'google-analytics-premium' ),
		);
	} else {
		$countries = array(
			''   => '',
...
function monsterinsights_detect_tracking_code_error( $body ) {
	...
	$cache_error = sprintf(
		esc_html__( '%1$sWe noticed you\'re using a caching plugin or caching from your hosting provider.%2$s Be sure to clear the cache to ensure the tracking appears on all pages and posts. %3$s(See this guide on how to clear cache)%4$s.', 'google-analytics-premium' ),
		'<b>',
		'</b>',
	...
	if ( $total_count > $limit ) {
		...
		$message           = esc_html__( '%1$sWe have detected multiple tracking codes%2$s! You should remove non-MonsterInsights ones. If you need help finding them please %3$sread this article%4$s.', 'google-analytics-premium' );
...
function monsterinsights_get_english_speaking_countries() {
	return array(
		...
		'RW' => __( 'Rwanda', 'google-analytics-premium' ),
		'SG' => __( 'Singapore', 'google-analytics-premium' ),
		'KN' => __( 'St Kitts and Nevis', 'google-analytics-premium' ),
		'LC' => __( 'St Lucia', 'google-analytics-premium' ),
		'VC' => __( 'St Vincent and the Grenadines', 'google-analytics-premium' ),
		'SZ' => __( 'Swaziland', 'google-analytics-premium' ),
		'WS' => __( 'Samoa', 'google-analytics-premium' ),
		'SC' => __( 'Seychelles', 'google-analytics-premium' ),
		'SL' => __( 'Sierra Leone', 'google-analytics-premium' ),
		'SB' => __( 'Solomon Islands', 'google-analytics-premium' ),
		'ZA' => __( 'South Africa', 'google-analytics-premium' ),
		...
		'SD' => __( 'Sudan', 'google-analytics-premium' ),
		'TT' => __( 'Trinidad and Tobago', 'google-analytics-premium' ),
		'BS' => __( 'The Bahamas', 'google-analytics-premium' ),
		'TZ' => __( 'Tanzania', 'google-analytics-premium' ),
		'TO' => __( 'Tonga', 'google-analytics-premium' ),
		'TV' => __( 'Tuvalu', 'google-analytics-premium' ),
		'GB' => __( 'United Kingdom', 'google-analytics-premium' ),
		'US' => __( 'United States of America', 'google-analytics-premium' ),
		'UG' => __( 'Uganda', 'google-analytics-premium' ),
		'VU' => __( 'Vanuatu', 'google-analytics-premium' ),
		'ZM' => __( 'Zambia', 'google-analytics-premium' ),
		'ZW' => __( 'Zimbabwe', 'google-analytics-premium' ),
