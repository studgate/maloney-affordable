...
<div class="monsterinsights-tracking-notice monsterinsights-tracking-notice-hide">
	...
	<div class="monsterinsights-tracking-notice-text">
		<h3><?php esc_html_e( 'Tracking is Disabled for Administrators', 'google-analytics-premium' ); ?></h3>
		<p>
			<?php
				...
				printf( esc_html__( 'To keep stats accurate, we do not load Google Analytics scripts for admin users. %1$sLearn More &raquo;%2$s', 'google-analytics-premium' ), '<a href="' . esc_url( $doc_url ) . '" target="_blank">', '</a>' );
			?>
		</p>
	</div>
