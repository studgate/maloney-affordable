...
class MonsterInsights_Tracking_Preview extends MonsterInsights_Tracking_Abstract {
	...
	public function frontend_output() {
		...
		$output .= '<!-- ' . esc_html__( "You are currently in a preview window. MonsterInsights doesn't track preview window traffic to avoid false visit reports.", 'google-analytics-premium' ) . ' -->';
