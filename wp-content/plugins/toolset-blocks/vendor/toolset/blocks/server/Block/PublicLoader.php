...
class PublicLoader {
	...
	public function initialize() {
        ...
        // Localize dates in block output
        add_filter( 'the_content', array( $this, 'localize_dates_in_block_output' ), 9 );
	}
    ...
    /**
     * Localize dates in block output using date_i18n.
     *
     * @param string $content Content
     *
     * @return string
     */
    public function localize_dates_in_block_output( $content ) {
        // Skip for English locales
