...
class WPV_Shortcode_Post_Body extends WPV_Shortcode_Base {
    ...
    private function get_infinite_loop_index() {
        ...
        switch ( $current_item_type ) {
            case 'posts':
                // Add null check before accessing $post->ID
                ...
                break;
            case 'taxonomy':
                // Check if taxonomy data exists before accessing
                if ( isset( $WP_Views->taxonomy_data['term'] ) && $WP_Views->taxonomy_data['term'] ) {
                ...
                break;
            case 'users':
                // Check if users data exists before accessing
                if ( isset( $WP_Views->users_data['term'] ) && $WP_Views->users_data['term'] ) {
