...
register_deactivation_hook( __FILE__, 'toolset_maps_deactivate' );

/**
 * Check dependencies, load required files and activate if possible
 *
 * @since 1.0
...
function toolset_addon_map_load_or_deactivate() {
	...
	if ( $do_load ) {
		define( 'TOOLSET_ADDON_MAPS_VERSION', '2.2.1' );
 ...
 * @since 2.0.9
 */
function toolset_maps_deactivate() {
	wp_unschedule_event(
